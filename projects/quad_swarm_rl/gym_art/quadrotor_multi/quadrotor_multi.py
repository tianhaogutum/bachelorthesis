...
class QuadrotorEnvMulti(gym.Env):
    ...
    def obst_generation_given_density(self, grid_size=1.0):
        ...
        for obst_id in [int(os.environ.get("OBST1_INDEX")), int(os.environ.get("OBST2_INDEX")), int(os.environ.get("OBST3_INDEX")), int(os.environ.get("OBST4_INDEX")), int(os.environ.get("OBST5_INDEX")), int(os.environ.get("OBST6_INDEX"))]:
            ...
            for drone2 in pos_arr:
                if drone1 < drone2:  
                    ...
                    for t in range(num_steps):
                        pos1 = pos_arr[drone1][t]  
                        pos2 = pos_arr[drone2][t] 
    ...
    def visualize_drones_positions(pos_dict, obst_arr, obst_size, target):
        ...
        obst_indexes = [float(os.environ.get(f"OBST{i+1}_INDEX")) for i in range(6)]
